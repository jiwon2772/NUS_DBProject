            ...
            {   
               ...
               for(Node tmpNode2:getAttributes(node))
               {
                  if(isAttribute(tmpNode2))
                  {
                     ...
                     {
                        relation.addKeyLists(attNode.name+"_Start");
                        System.out.println(attNode.getName()+"_Start(Key)");
                        relation.addAttLists(attNode.name+"_End");
                        System.out.println(attNode.getName()+"_End");
                     }
                  ...
                  if(isAttribute(tmpNode))
                  {
                     ...
                     if(attNode.isTemporal&&attNode.getIsMulti())
                     {
                        ...
                        System.out.print(attNode.name+"(key), ");
                           ...
                           System.out.print(attNode.name+"_Start(Key), ");
                           relation2.addAttLists(attNode.name+"_End");
                           System.out.print(attNode.name+"_End, ");
                           R.add(relation2);
                     }
                  }
                           ...
                           {   
                              if(isAttribute(tmpNode3))
                              {
                                 ...
                                 if(attNode3.getIsKey()){
                                    System.out.print(attNode3.name+"(key), ");
               ...
               for(Node tmpNode:getAttributes(node))
               {
                  ...
                  if(isAttribute(tmpNode))
                  {
                     ...
                     if(attNode.isTemporal&&attNode.getIsMulti())
                     {
                        ...
                        if(!tmp1){
                        System.out.println("Relationship_mt - "+node.name);
