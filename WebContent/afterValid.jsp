        ...
        $(go.TextBlock,   // the label text
          {
           ...
           new go.Binding("text","multi").makeTwoWay()),
          $(go.Panel, "Auto",
      ...
      $(go.Palette, "myPaletteDiv",  // must name or refer to the DIV HTML element
        {
          ...
          model: new go.GraphLinksModel([  // specify the contents of the Palette
            { text: "Entity", figure: "RoundedRectangle", fill: "lightyellow", size: "150 70", type:"E", isTemp: "false"},
            { text: "Relationship", figure: "Diamond", fill: "lightskyblue",type:"R", isTemp: "false"},
            { text: "Attribute", figure: "Ellipse", fill: "#00AD5F",type:"A", isTemp: "false"}
          ], [
